...
namespace komp
{
    public partial class rejestracja : System.Web.UI.Page
    {
        ...
        protected void rejestruj_Click(object sender, EventArgs e)
        {
            ...
            rej_con.Open();
            rej_cmd_Sel = new SqlCommand("Select * from uzytkownicy where login = '"+login.Text+"'");
            ...
            */
            ...
            {
                bledy.Add("Brak powtorzenia hasla!");
            ...
            if (!checkbox_regulamin.Checked)
            {
                bledy.Add("Musisz zaakceptować regulamin!");
                regulamin_text.Style["color"] = "red";
            }
            else
            {
                regulamin_text.Style["color"] = "black";
            }
            Label1_b.Text = "";
            if(bledy.Count > 0){
                ...
                rej_con = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["CS"].ConnectionString);
                rej_con.Open();
                rej_cmd_insert = new SqlCommand("INSERT INTO uzytkownicy"
